...
exports.postArticle = async (req, res) => {
  try {
    const { articleTitle, contentData } = req.body;
    ...
    await Article.create(
      { title: articleTitle, mainImage, author_id: req.user.user_id },
      processed
    );
...
exports.updateArticle = async (req, res) => {
  try {
    ...
    await Article.update(id, { title: articleTitle, mainImage }, processed);
    res.json({ success: true });
  } catch (err) {
    console.error(err);
