...
router.post('/model', auth, uploadModels.any(), adminmodel.postAdminModel); // UPDATE
router.get('/model/:modelId', auth, adminmodel.getModelById);
router.post('/model/update/:modelId', auth, uploadModels.any(), adminmodel.updateAdminModel); // UPDATE
