...
router.post('/model', auth, uploadModels.any(), adminmodel.postAdminModel);
router.get('/model/:modelId', auth, adminmodel.getModelById); // EDIT: Load form
router.post('/model/update/:modelId', auth, uploadModels.any(), adminmodel.updateAdminModel);
router.post('/model/delete/:modelId', auth, adminmodel.deleteAdminModel); // DELETE
