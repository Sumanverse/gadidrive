...
// UPLOAD MIDDLEWARES
const uploadAdmin = require('../utils/uploadadmin');       // profile_picture
const uploadVehicle = require('../utils/uploadVehicle');   // vehicle_type_photo
...
router.post('/model', auth, adminmodel.postAdminModel);
router.get('/model/:modelId', auth, adminmodel.getModelById);
router.post('/model/update/:modelId', auth, adminmodel.updateAdminModel);
