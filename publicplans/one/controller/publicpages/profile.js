...
exports.updateSocialMedia = async (req, res) => {
    try {
        ...
        console.log('Received socialMedia:', socialMedia); // DEBUG
        ...
        // CRITICAL: JSON.stringify() → DB ma valid JSON save huncha
        const jsonString = JSON.stringify(valid);
        console.log('Saving to DB:', jsonString); // DEBUG

        await UserDetails.updateUser(userId, { social_media: jsonString });
