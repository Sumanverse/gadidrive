...
router.post('/article', auth, uploadArticle, adminarticle.postArticle);
router.put('/article/:id', auth, uploadArticle, adminarticle.updateArticle);
router.delete('/article/:id', auth, adminarticle.deleteArticle);
